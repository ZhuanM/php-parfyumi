...
<footer>
    <div class="row ml-0 mr-0 mt-2 justify-content-center">
        <div class="col-auto d-flex align-items-center">
            <a class="anchor-color-unset" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/">
                <i class="fab fa-facebook social-media-icons pointer"></i>
            </a>
        </div>
        <div class="col-auto d-flex align-items-center">
            <a class="anchor-color-unset" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/">
                <i class="fab fa-instagram social-media-icons pointer"></i>
            </a>
        </div>
        <div class="col-auto d-flex align-items-center">
            <a class="anchor-color-unset" target="_blank" rel="noopener noreferrer" href="https://www.twitter.com/">
                <i class="fab fa-twitter social-media-icons pointer"></i>
            </a>
        </div>
        <div class="col-auto d-flex align-items-center">
