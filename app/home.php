...
<div class="main-screen drag-to-navbar">
  ...
  <div class="row m-0 second-view pl-4 pr-4 pb-5 pt-4 align-items-center">
    <div class="col p-0">
      ...
      <div class="row m-0">
        <div class="col-xs-12 col-md-5 col-lg-6 col-xl-2 p-0 container info-card first">
        ...
        <div class="col-xs-12 col-md-5 col-lg-6 col-xl-2 p-0 container info-card second">
          <div class="card-img-wrapper">
        ...
        <div class="col-xs-12 col-md-5 col-lg-6 col-xl-2 p-0 container info-card third">
          <div class="card-img-wrapper">
        ...
        <div class="col-xs-12 col-md-5 col-lg-6 col-xl-2 p-0 container info-card fourth">
          <div class="card-img-wrapper">
        ...
        <div class="contact-card p-3">
            <form>
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="name-contact" aria-describedby="emailHelp" placeholder="Напишете вашето име">
                </div>
                <div class="form-group mb-3">
                    <label for="email-contact">Имейл</label>
                    <input type="text" class="form-control" id="email-contact" placeholder="Напишете вашият имейл">
                </div>
                <div class="form-group">
                    <label for="message-contact">Съобщение</label>
                    <textarea class="form-control" id="message-contact" rows="3" cols="50" placeholder="Напишете вашето съобщение"></textarea>
                </div>
